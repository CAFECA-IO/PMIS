...
export function EhsForm({
  ...
  return (
    <form action={createEhsAction} className="space-y-4">
      {/* Info: (20260721 - Luphia) 照片判讀（選填）— 由費思填入欄位，或直接手動輸入 */}
      ...
      {/* Info: (20260721 - Luphia) 稽核欄位（可手動或於判讀後確認） */}
      ...
      <div className="flex items-center gap-2">
        <Button type="submit">建立稽核</Button>
